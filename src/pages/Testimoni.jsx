      ...
      <Container>
        <Row>
          <Col>
            ...
            <p className="text-center animate__animated animate__fadeInUp animate__delay-1s">Testimoni dari penghuni Aina Kost tentang kenyamanan dan fasilitas kami</p>
          </Col>
        </Row>
